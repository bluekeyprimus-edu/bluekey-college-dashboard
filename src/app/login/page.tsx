...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push(redirectTo || (role === "counselor" ? "/" : "/parent"));
    router.refresh();
  }
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="font-serif text-xl font-semibold text-navy-900">BlueKey 로그인</h1>
          <p className="mt-1 text-sm text-navy-500">카운슬러 또는 학부모 계정으로 로그인하세요.</p>
        </div>
